...
{% endif %}
		...
		["Main"]={
			...
			["Button 5-5"]={template="BOscSel"},
			["Button 5-6"]={template="BOscSel"},
			["Button 5-7"]={template="BOscSel"},
			["Button 5-8"]={template="BOscSel"},
			["Button 6-7"]={template="BOscSel"},
			["Button 6-8"]={template="BOscSel"},
			-- Edit Steps, Accent
			...
			-- Play, Solo, Mute
			["Button 6-3"]={template="BMute"},
			["Button 6-4"]={template="BSoloRevival"},
			["Button 6-5"]={template="BPlaySel"},
			["Play"]={
