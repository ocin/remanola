...
{% include "devices/instrument/revival/"+lptype+"/confmap_mainmenu.lua" %}
		...
		["Index"]={
			["Button 2-4"]={template="BFilterPageHigh"},
			["Button 3-4"]={template="BFilterPageHigh"},
			["Button 4-4"]={template="BFilterPageHigh"},
			["Button 5-4"]={template="BFilterPageHigh"},
			["Button 2-5"]={template="BFilterModPageHigh"},
			["Button 3-5"]={template="BFilterModPageHigh"},
			["Button 4-5"]={template="BFilterModPageHigh"},
			["Button 5-5"]={template="BFilterModPageHigh"},
			["Button 2-6"]={template="BFilterModPageHigh"},
			["Button 3-6"]={template="BFilterModPageHigh"},
			["Button 4-6"]={template="BFilterModPageHigh"},
			["Button 5-6"]={template="BFilterModPageHigh"},
			["Button 2-7"]={template="BFilterModPageHigh"},
			["Button 3-7"]={template="BFilterModPageHigh"},
			["Button 4-7"]={template="BFilterModPageHigh"},
			["Button 5-7"]={template="BFilterModPageHigh"},
		},
		["Main"]={
			-- S1/S2 switches
