...
{% include "devices/instrument/europa/"+lptype+"/confmap_mainmenu.lua" %}
		...
		["Index"]={
			["Button 7-1"]={template="BPerformancePageHigh"},
			["Button 7-2"]={template="BPerformancePageHigh"},
			["Button 7-3"]={template="BPerformancePageHigh"},
			["Button 7-4"]={template="BPerformancePageHigh"},
			...
			["Button 5-5"]={template="BFilterPageHigh"},
			["Button 2-7"]={template="BEffect2PageHigh"},
			["Button 3-7"]={template="BEffect2PageHigh"},
			["Button 4-7"]={template="BEffect2PageHigh"},
		},
		["Mixer"]={
