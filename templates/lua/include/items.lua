local items = {
	...
	{name = "Fader 2", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 3", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 4", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 5", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 6", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 7", input = "value", output = "value", min = 0, max = 16383},
	{name = "Fader 8", input = "value", output = "value", min = 0, max = 16383},
