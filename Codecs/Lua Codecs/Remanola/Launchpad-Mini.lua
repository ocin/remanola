...
local item_conf_map = {
	...
	["Redrum"]={
		...
		["Main"]={
			...
			["UDVButton 5-8_6-8"]={template="FGreen"},
			-- Flam
			["UDHButton 7-5_7-6"]={template="FAmber"},
	...
	["Thor"]={
		...
		["Osc *"]={
			["Button 1-2"]={enabledcolor=AMBER,     activecolor=AMBER,   disabledcolor=NOCOLOR},
		...
		["Filter *"]={
			["Button 1-2"]={enabledcolor=GREEN,     activecolor=GREEN,   disabledcolor=NOCOLOR},
